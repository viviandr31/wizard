...
function updaterowproperties()
{
    ...
    $('.answertable tbody').each(function(){
        ...
        $(this).children('tr').each(function(){
            ...
            $(this).find('.answer-field .editorLink').attr('href','javascript:start_popup_editor(\'answer_'+language+'_'+rownumber+'_'+scale_id+'\',\'[Answer:]('+language+')\',\''+sID+'\',\''+gID+'\',\''+qID+'\',\'editanswer\',\'editanswer\')');
            $(this).find('.answer-field .editorLink').attr('id','answer_'+language+'_'+rownumber+'_'+scale_id+'_ctrl');
            $(this).find('.answer-field .btneditanswerena').attr('id','answer_'+language+'_'+rownumber+'_'+scale_id+'_popupctrlena');
            $(this).find('.answer-field .btneditanswerena').attr('name','answer_'+language+'_'+rownumber+'_'+scale_id+'_popupctrlena');
            $(this).find('.answer-field .btneditanswerdis').attr('id','answer_'+language+'_'+rownumber+'_'+scale_id+'_popupctrldis');
            $(this).find('.answer-field .btneditanswerdis').attr('name','answer_'+language+'_'+rownumber+'_'+scale_id+'_popupctrldis');


            // feedback 
            $(this).find('.feedback').attr('id','feedback_content_'+rownumber+'_'+scale_id);
            $(this).find('.feedback').attr('name','feedback_content_'+rownumber+'_'+scale_id);
            
            $(this).find('.feedback-field .editorLink').attr('href','javascript:start_popup_editor(\'feedback_content_'+rownumber+'_'+scale_id+'\',\'[Feedback Content:]('+language+')\',\''+sID+'\',\''+gID+'\',\''+qID+'\',\'editanswer\',\'editanswer\')');
            $(this).find('.feedback-field .editorLink').attr('id','feedback_content_'+rownumber+'_'+scale_id+'_ctrl');
            $(this).find('.feedback-field .btneditanswerena').attr('id','feedback_content_'+rownumber+'_'+scale_id+'_popupctrlena');
            $(this).find('.feedback-field .btneditanswerena').attr('name','feedback_content_'+rownumber+'_'+scale_id+'_popupctrlena');
            $(this).find('.feedback-field .btneditanswerdis').attr('id','feedback_content_'+rownumber+'_'+scale_id+'_popupctrldis');
            $(this).find('.feedback-field .btneditanswerdis').attr('name','feedback_content_'+rownumber+'_'+scale_id+'_popupctrldis');
