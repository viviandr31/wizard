...
<div class="<?php echo $coreClass; ?> row" role="group" aria-labelledby="ls-question-text-<?php echo $basename; ?>">
    <div class="answers-list radio-list col-xs-12">
    ...
    <div class="form-group answer-item text-item col-xs-12">
        <label style="font-size:13px;" class="control-label" for="<?php echo $id; ?>">
