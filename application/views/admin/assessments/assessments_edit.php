        ...
        <?php echo CHtml::form(array("admin/assessments/sa/index/surveyid/{$surveyid}"), 'post', array('class'=>'form','id'=>'assessmentsform','name'=>'assessmentsform', 'role' => 'form'));?>
          ...
          <div class="modal-body">
            ...
            <div class='row'>
              ...
              <!-- IDK Minimum -->
                <div class='form-group col-md-12'>
                <label class='control-label col-sm-4' for='idk_minimum'>
                  <?php eT("I don't know Minimum:");?>
                </label>
                <div class='col-sm-8'>
                  <input class='form-control numbersonly' type='text' id='idk_minimum' name='idk_minimum' />
                </div>
                <div class='col-sm-2 hide-xs'></div>
              </div>
              ...
              <!-- IDK Maximum -->
              <div class='form-group col-md-12'>
                <label class='control-label col-sm-4' for='idk_maximum'>
                  <?php eT("I don't know Maximum:");?>
                </label>
                <div class='col-sm-8'>
                  <input class='form-control numbersonly' type='text' id='idk_maximum' name='idk_maximum' />
                </div>
                <div class='col-sm-2 hide-xs'></div>
              </div>
            </div>
