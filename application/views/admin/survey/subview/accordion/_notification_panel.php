...
<div id='notification-panel'  class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <!-- email cc to  -->   
            <div class="form-group">
                <label class=" control-label" for='emailccto'><?php  eT("CC invitation and reminder email to:"); ?></label>
                <div class="">
                    <?php echo CHtml::textField('emailccto',$oSurvey->emailccto,array('size'=>70, 'class'=>"form-control")) ?>
                </div>
            </div>
