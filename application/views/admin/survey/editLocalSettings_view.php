    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <!-- Report Header -->
                <div class="form-group">
                    <label class=" control-label" for='report_heaer'><?php eT("Report Header:"); ?></label>
                    <div class="">
                    <div class="htmleditor input-group">
                        <?php echo CHtml::textArea("report_header",$aSurveyLanguageSettings['report_header'],array('class'=>'form-control','cols'=>'80','rows'=>'15','id'=>"report_header")); ?>
                        <?php echo getEditor("report_header","report_header", "[".gT("Report header:", "js")."](".$aSurveyLanguageSettings['surveyls_language'].")",$surveyid,'','',$action); ?>
                    </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-lg-6">
                <!-- Report Footer -->
                <div class="form-group">
                    <label class=" control-label" for='report_footer'><?php eT("Report Footer:"); ?></label>
                    <div class="">
                    <div class="htmleditor input-group">
                        <?php echo CHtml::textArea("report_footer",$aSurveyLanguageSettings['report_footer'],array('class'=>'form-control','cols'=>'80','rows'=>'15','id'=>"report_footer")); ?>
                        <?php echo getEditor("report_footer","report_footer", "[".gT("Report footer:", "js")."](".$aSurveyLanguageSettings['surveyls_language'].")",$surveyid,'','',$action); ?>
