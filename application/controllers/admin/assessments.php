...
class Assessments extends Survey_Common_Action
{
    ...
    private function setSearchParams(Assessment $oAssessments)
    {
        ...
        if (isset($_POST['Assessment']['idk_minimum'])) {
            $oAssessments->idk_minimum = $_POST['Assessment']['idk_minimum'];
        }

        if (isset($_POST['Assessment']['idk_maximum'])) {
            $oAssessments->idk_maximum = $_POST['Assessment']['idk_maximum'];
        }
    ...
    private function _getAssessmentPostData($iSurveyID, $language)
    {
        ...
        return array(
            ...
            'idk_minimum' => (int) App()->request->getPost('idk_minimum', 0),
            'idk_maximum' => (int) App()->request->getPost('idk_maximum', 0),
