 ...
 * @property string $idk_minimum
 * @property string $idk_maximum
...
class Assessment extends LSActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'minimum' => gT("Minimum"),
            'maximum' => gT("Maximum"),
            'idk_minimum' => gT("I dont know Minimum"),
            'idk_maximum' => gT("I dont know Maximum"),
            'message' => gT("Message"),
    ...
    public function search()
    {
        ...
        $criteria->compare('idk_minimum', $this->idk_minimum);
        $criteria->compare('idk_maximum', $this->idk_maximum);
